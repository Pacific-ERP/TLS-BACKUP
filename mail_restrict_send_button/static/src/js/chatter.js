odoo.define("mail_restrict_send_button/static/src/js/chatter.js", function (require) {
    "use strict";
    ...
    registry["mail.chatter"].factory = function (dependencies) {
        ...
        class Chatter extends dependencies["mail.model"] {
            ...
            toggleActivityBoxVisibility() {
                this.update({
                    isActivityBoxVisible: !this.isActivityBoxVisible,
                });
            }
            ...
            _onThreadIsLoadingAttachmentsChanged() {
                ...
                if (
                    ...
                    this.isShowingAttachmentsLoading
                ) {
                    return;
                }
        ...
        Chatter.fields = {
            ...
            hasThreadView: attr({
                ...
                dependencies: ["hasMessageList", "thread"],
            }),
            ...
            isDisabled: attr({
                ...
                default: false,
                dependencies: ["threadIsTemporary"],
            }),
            /**
            ...
            onThreadIsLoadingAttachmentsChanged: attr({
                ...
                dependencies: ["threadIsLoadingAttachments"],
            }),
            /**
