...
class SaleOrderInherit(models.Model):
    ...
    def _get_deliveries_state(self):
        ...
        for sale in self:
            ...
            elif (all(line.state in ('done','cancel') for line in sale.delivery_line) and sale.delivery_line) or (all(line.product_id.detailed_type == 'service' for line in sale.order_line)): 
                #  and line.product_id.company_id.id != 2 or sale.is_deliver
